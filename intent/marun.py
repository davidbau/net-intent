...
from intent.mask import CHANNEL_MASK
import json
...
def main(save_to, num_epochs,
    ...
    mask_vars = VariableFilter(
            roles=[CHANNEL_MASK])(test_cg.variables)
    drop_cg = apply_dropout(test_cg, mask_vars, 0.5)
...
if __name__ == "__main__":
    ...
    parser.add_argument("save_to", default="cifar10-ma.tar", nargs="?",
